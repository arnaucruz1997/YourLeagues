...
export class CompetitionComponent implements OnInit {
  ...
  iniciarCompeticio(){
    ...
    this.compService.createPartits(this.competition.equips, this.competition.id, this.competition.organitzador, this.competition.tipusSport, this.competition.numVoltes);
  }
}
